// Deploy-time database seed. You own this file.
//
// seed() runs once when the server boots (via src/instrumentation.ts), on the
// Node server, AFTER the schema is applied. Use it for reference/lookup data your app needs to exist BEFORE the first request:
...
//   3. NOT for recurring work or per-user/
